...
<template>
    <div class="flex-1">
        <div class="flex flex-col gap-6">
             <div class="flex-1">
                <span class="text-2xl font-bold">Support
                    <small class="text-xs font-normal">
                        Translate to
                        <button @click="changeLang" class="font-semibold py-1 px-2 text-white dark:text-gray-300 bg-sky-500 dark:bg-gray-600 rounded-md">
                ...
                <template v-if="lang">
                    <div class="flex flex-col gap-3 mt-3 font-normal text-justify">
                        <p>
                            Dari sekarang dan seterusnya, Typewrite tetap akan menjadi game browser gratis dengan sumber terbuka.
                        </p>
                        <p>
                            Tapi, sekarang saya butuh bantuan kecil.
                            Teman lagi ikuti kompetisi komik, dan dia lolos 15 besar, 
                            tapi untuk seleksi finalnya pake sistem voting di Discord Paras Comic.
                        </p>
                        <p>
                            Jadi kalau kamu mungkin punya akun Discord, kamu bisa dukung dengan ngasih vote dari link di bawah ini sebelum 18 Juli 2022, atau mungkin
                            kalau gak punya Discord bisa baca komiknya aja, barang kali tertarik.
                            Komiknya menarik, digambar pake style manga/anime dengan penceritaan kisah tragis tokoh utamanya.
                        </p>
                ...
                <template v-else>
                    <div class="flex flex-col gap-3 mt-3 font-normal text-justify">
                    <p>
                        Until now and than, Typewrite will be always a free play open source browser game.
                    </p>
                    <p>
                        However, i need a little support just for this time.
                        Right now my friend is participating a comic competition and he get top 15 position, he
                        deserve it, but for the final selection he need people to vote his comic on Paras Comic Discord.
                    </p>
                    <p>
                        So if you have discord, you can support him in the link below  before 18 July 2022, or if you don't have Discord you can just read the comic for free in
                        Paras Comic. His comic is really awesome, with anime style comic wraped in tragic main characther story.
                    </p>
                    <span class="font-bold">
                        How To Vote
                    </span>
