...
<script setup>
import { ref, inject, onMounted, onUnmounted, defineComponent, watchEffect, computed } from 'vue'
...
<template>
    <div class="flex-1">
        <div class="flex flex-col justify-start gap-4 mb-6">
            <div class="flex-1">
                <div class="flex flex-col flex-wrap gap-6">
                        ...
                        <DropZone class="drop-area" @files-dropped="addFiles" #default="{ dropZoneActive }">
                            ...
                            <div for="file-input" class="font-normal">
                                ...
                                <template v-else>
                                    ...
                                    <span>
                                        or click<strong>Choose Image</strong> to select files.
                                    </span>
                                </template>
                    ...
                    <div class="flex-1">
                        ...
                        <input type="range" @change="timerBg()" class="custom-range mt-4" v-model="bgTime" min="1000"
                            step="1000" max="1000000" name="" id="">
                    </div>
